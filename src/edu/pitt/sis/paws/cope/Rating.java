...
{
	// CONSTANTS
//	/** Text labels for likert 5-scale ratings
//	 * @since 1.5
//	 */
//	public static final String[] LIKERT_LABELS = {
...
//		"<span style='color:green;'>Highly Relevant</span>"};
		...
		User _user, iNode _rated_node)
	{
		...
		{
			System.out.println("Rating.constructor illegal rating value(" + 
	...
	public void addRating(Rating new_rating)
	{
		if(is_group_rating)
		{
			...
			System.out.println("Rating.addRating ERROR! Trying to add rating to a single value rating.");
	}
	...
	public void setRatingValue(float _rating_value)
	{
		if(is_group_rating)
		{
			System.out.println("Rating.addRating ERROR! Trying to set a value for a group rating.");
			return;
		}
		else
			rating_value = _rating_value;
	...
	{
		if(!is_group_rating)
			System.out.println("Rating.addRating WARNING! You are " + 
	...
	public void setAnonymous(boolean _is_anonymous)
	{
		if(is_group_rating)
		{
			System.out.println("Rating.addRating ERROR! Trying to set an anonymity value for a group rating.");
			return;
		}
		else
