 ...
 * @author Michael V. Yudelson
 */
public class doCopy extends servletGeneric
{
...
//		out.println("~~~ [CoPE] doCopy Parameters<br/>");
		...
		String id_s = request.getParameter(iNode.NODE_FRMFIELD_ID);
		...
		if(id_s == null)
		{
			System.out.println("~~~ ERROR! doCopy.doPost: Parent node id not specified");
			out.println("<body>");
		...
		for(;enu.hasMoreElements();)
		{
			...
			{
				if(target != null)
					System.out.println("~~~ ERROR! doCopy:: multiple targets specified");
