...
//	}
	...
	public Object clone() 
	{
		...
		{
//			if(this.isGroup)
				copy = new User(this.getId(),new String(this.getTitle()), new String(this.getURI()),
...
//	public int compareTo(Object e) { return title.compareTo(((Node)e).title); }
	...
	public void setLogin(String _login)
	{
		...
		else System.out.println("Error! User id " + getId() + " is a group. Cannot set login!");
	}
	...
	{
		return "[ User title:'" + getTitle() + "' id:" + getId() + 
